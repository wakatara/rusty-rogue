...
impl State {
    ...
    fn game_over(&mut self, ctx: &mut BTerm) {
        ...
        ctx.print_color_centered(4, WHITE, BLACK, "The Amulet of Yara remains unclaimed and your home town is unsaved.");
    ...
    fn advance_level(&mut self) {
        ...
        // Set Field of view as dirty to reset (and gen) for next level
...
fn main() -> BError {
    let context = BTermBuilder::new()
        .with_title("Pukey Nephew Dungeon")
        .with_fps_cap(30.0)
